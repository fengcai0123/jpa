        ...
        <table class="table table-responsive table-bordered">
            ...
            <c:forEach items="${goodList}" var="item" varStatus="status">
                <tr>
                    ...
                    <td>${item.size}</td>
                    <td>${item.totalSellNum}</td>
                    <td>${item.weight}</td>
                    <td><a href="${pageContext.request.contextPath}/inventory/list?asin=${item.asin}">查看库存</a></td>
                    <td><a href="${pageContext.request.contextPath}/sell/list?asin=${item.asin}">销量详情</a></td>
                    <td><a href="${pageContext.request.contextPath}/price/list?asin=${item.asin}">价格详情</a></td>
                    <td><a href="${pageContext.request.contextPath}/comment/list?asin=${item.asin}">评分详情</a></td>
                    <td><a href="${pageContext.request.contextPath}/bsr/list?asin=${item.asin}">BSR详情</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
